...
function AccountOperations() {
  ...
  // const loanPurposeStore = useSelector((state: RootState) => state.account.loanPurpose);
  //const [currency, setCurrency] = useState("USD");

  const { balance, loan, isActive } = useSelector((state: RootState) => state.account);
    ...
    <div>
      ...
      <div className='inputs'>
        ...
        <button onClick={handleDeposit} disabled={isLoading}>
          ...
          <button onClick={handleDeposit}>depositAmount</button>
        </div>
        ...
        <div>
          ...
          <input
            value={loanPurpose}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setLoanPurpose(e.target.value)}
